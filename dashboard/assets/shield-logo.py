...
# Plot the pattern
ax.contourf(X, Y, Z, levels=20, cmap=cm.Blues_r, alpha=0.4)
...
plt.tight_layout()
plt.savefig(os.path.join(os.path.dirname(__file__), "shield-logo.png"), 
           dpi=300, transparent=True, bbox_inches='tight', pad_inches=0.1)
plt.close()

print("Shield logo created successfully!")
